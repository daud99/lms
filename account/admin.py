...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        (None, {'fields': ('email', 'password', 'full_name', 'role', 'job_category_id', 'organization_id', 'image_url', 'fcm_id', 'os_type', 'device_unique_id', 'notification_status', 'created_date', 'updated_date', 'status')}),
